namespace Chess {
	...
	public static class PrecomputedMoveData {
		// Wartości pól otaczających dane pole (N, S, W, E, NW, SE, NE, SW)
		public static readonly int[] directionOffsets = { 8, -8, -1, 1, 7, -7, 9, -9 };

		// Przechowuje ilość ruchów możliwych w każdym możłiwym kierunku dla każdego pola na tablicy
		// Wg kolejności: N, S, W, E, NW, SE, NE, SW
		// Więc na przykład, jeśli availableSquares[0][1] == 8...
		// to znaczy, że jest 8 pól do pola B1
		public static readonly int[][] numSquaresToEdge;

		// Przechowuje tablice znaków dla każego pola na które skoczek może skoczyć z dowolneego kwadratu na planszy
		// Więc np knightMoves[0] jest równy {10, 17}, oznaczając, że skoczek stojący na A1 może skoczyć na C2 i B3
		public static readonly byte[][] knightMoves;
		public static readonly byte[][] kingMoves;

		// Atak piona na ukos (zarówno dla białych i czarnych NW, NE; SW SE)
		...
		// ilość ruchów, żeby przejść z punktu a do punktu b
